...
class BrowserCredentialStore @Inject constructor(
    ...
    private companion object {
        ...
        const val KEY_ALIAS = "minime_browser_cred"
    ...
    fun find(host: String): BrowserCredential? {
        ...
        return try {
            ...
            MiniMeLog.e(TAG, "解密凭据失败 host=$normalized", e)
            null
        }
    }
    ...
    fun save(host: String, username: String, password: String) {
        ...
        try {
            ...
            MiniMeLog.i(TAG, "凭据已加密保存 host=$normalized")
        } catch (e: Exception) {
            MiniMeLog.e(TAG, "加密保存凭据失败 host=$normalized", e)
        }
    }
