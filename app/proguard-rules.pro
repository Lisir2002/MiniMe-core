...
-keep class com.mini.me_core.feature.agent.data.remote.** { *; }
...
-keepclassmembers class com.mini.me_core.** {
    <init>();
}
...
-keep,includedescriptorclasses class com.mini.me_core.**$$serializer { *; }
-keepclassmembers class com.mini.me_core.** {
    *** Companion;
}
-keepclasseswithmembers class com.mini.me_core.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.mini.me_core.**.entity.** { *; }   # Room @Entity 不可混淆列名映射
