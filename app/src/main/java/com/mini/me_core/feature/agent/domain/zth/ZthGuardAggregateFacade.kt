...
class ZthGuardAggregateFacade @Inject constructor(
    ...
    private suspend fun triggerCardSuspend(
        vm: com.mini.me_core.feature.agent.presentation.ZthConfirmationCardViewModel,
        ...
        val payload = com.mini.me_core.feature.agent.presentation.ZthConfirmationCardViewModel.ConfirmationCardPayload(
