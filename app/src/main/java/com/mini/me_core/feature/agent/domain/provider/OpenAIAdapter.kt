...
import kotlinx.serialization.json.jsonObject
import com.mini.me_core.feature.agent.data.remote.openai.OpenAIToolCall
import com.mini.me_core.feature.agent.data.remote.openai.OpenAIToolDefinition
import com.mini.me_core.feature.agent.data.remote.openai.OpenAIFunctionDefinition
import com.mini.me_core.feature.agent.data.remote.openai.StreamOptions
...
class OpenAIAdapter @Inject constructor(
    ...
    private fun convertToOpenAIToolCall(toolCall: ToolCall): OpenAIToolCall {
        return OpenAIToolCall(
            id = toolCall.id,
            type = "function",
            function = com.mini.me_core.feature.agent.data.remote.openai.OpenAIFunctionCall(
                name = toolCall.name,
