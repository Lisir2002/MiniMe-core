...
class TerminalKeepaliveService : Service() {
     ...
     * 不应让进程崩溃（设置页的开关仍是开启态，下次前台时由 [com.mini.me_core.MainActivity] 恢复）。
     */
    ...
    companion object {
        ...
        const val ACTION_START_SESSION = "com.mini.me_core.action.START_SESSION"
        const val ACTION_STOP_SESSION = "com.mini.me_core.action.STOP_SESSION"
        const val ACTION_ENABLE_PERSISTENT = "com.mini.me_core.action.ENABLE_PERSISTENT"
        const val ACTION_DISABLE_PERSISTENT = "com.mini.me_core.action.DISABLE_PERSISTENT"
