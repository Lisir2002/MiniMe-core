 ...
 * 旧 frontmatter `scope: common` 由 [com.mini.me_core.feature.agent.domain.skill.SkillParser] 映射为 GLOBAL。
 */
...
data class Skill(
     ...
     * 作为自动化流程的一环，无需关键词触发或依赖模型自觉调用 [com.mini.me_core.feature.agent.domain.tool.skill.LoadSkillTool]。
     */
