...
import com.mini.me_core.feature.agent.domain.input.BehaviorModeSource
import com.mini.me_core.feature.agent.domain.input.GoalAdjustEventSource
import com.mini.me_core.feature.agent.domain.input.GoalHintSource
import com.mini.me_core.feature.agent.domain.input.GoalStaleSource
import com.mini.me_core.feature.agent.domain.input.IntentAskSource
import com.mini.me_core.feature.agent.domain.input.LoopAdvisorySource
import com.mini.me_core.feature.agent.domain.input.PlanPendingHintSource
import com.mini.me_core.feature.agent.domain.input.PlaybookStageSource
import com.mini.me_core.feature.agent.domain.memory.MemoryRepository
import com.mini.me_core.feature.agent.domain.memory.MemoryScope
...
import com.mini.me_core.feature.agent.domain.rule.RuleLayer
...
class SystemPromptProvider @Inject constructor(
    ...
    fun enqueueGoalAdjustEvent(sessionId: String, event: com.mini.me_core.feature.agent.domain.input.GoalAdjustEvent): Boolean =
