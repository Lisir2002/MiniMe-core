...
class SentinelLogicTest {
    ...
    private val meta = RunMeta(
        ...
        lastVersionCode = 100,
        lastApplicationId = "com.mini.me_core",
    )
    ...
    fun `未初始化_首次运行_返回FIRST_RUN`() {
        val verdict = SentinelLogic.evaluate(
            ...
            currentApplicationId = "com.mini.me_core",
            sessionCount = 0,
        )
    ...
    fun `包名变更_优先返回PACKAGE_CHANGED`() {
        ...
        val verdict = SentinelLogic.evaluate(
            ...
            currentApplicationId = "com.other.package", // 与 meta.lastApplicationId 不一致
            sessionCount = 0,
        )
